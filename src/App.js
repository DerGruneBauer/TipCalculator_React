...
function App() {
  ...
  return (
    <div className="App">
      ...
      <CalculatorContainer onResetClick={resetForm} totalPer={calculateTotalPerPerson()} tipTotalPer={calculateTipPerPerson()} onPeopleChange={collectNumberPeople} onBillChange={collectBillAmount} onTipClick={collectTipPercentage} bill={bill} tip={tipPercentage} people={numberPeople}/>
    </div>
  );
}
